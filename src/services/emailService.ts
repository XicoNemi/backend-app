...
export const newAccount = async (name: string, email: string, token: string) => {
    ...
    <![endif]--></div>
        ...
        attachments: [
            {
                filename: 'logo.png',
                path: path.resolve(__dirname, '../public/logo.png'), // Ruta absoluta
                cid: 'logo',
            },
            {
                filename: 'virgen.jpg',
                path: path.resolve(__dirname, '../public/virgen.jpg'),
                cid: 'virgen',
            },
            {
                filename: 'google.jpg',
                path: path.resolve(__dirname, '../public/google.jpg'),
                cid: 'google',
            },
            {
                filename: 'appstore.jpg',
                path: path.resolve(__dirname, '../public/appstore.jpg'),
                cid: 'appstore',
            },
        ]
    }
